...
public class Rpgcharacter {
    ...
    public Rpgcharacter() {
        ...
        //Iterator itr = attributes.iterator(); *note the iterator works but for each req. less calls

        /*while (itr.hasNext()) {
            Attribute x  = (Attribute)itr.next();
        ...
        //System.out.println(attributes.get(0).getG().toString());
    ...
    public String raceComplex(ArrayList<Attribute> attr, int rv) {
        ArrayList<Attribute> attributesrace = new ArrayList<>();

        String[] bloob = {"Elf","Human","Dwarf", "Orc", "Beastkin", "Demon", "Dragon", "Satyr"};
